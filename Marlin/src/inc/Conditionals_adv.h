...
#define ANY_THERMISTOR_IS(N) ( ANY_E_SENSOR_IS(N) _SENSOR_IS(N,REDUNDANT) \
  ...
  #define TEMP_SENSOR_0_IS_THERMISTOR 1
    ...
    #if   TEMP_SENSOR_1 == -5
      #error "如果使用MAX31865热电偶(-5)作为TEMP_SENSOR_1，则TEMP_SENSOR_0必须匹配。"
    #elif TEMP_SENSOR_1 == -3
      #error "如果使用MAX31855热电偶(-3)作为TEMP_SENSOR_1，则TEMP_SENSOR_0必须匹配。"
    #elif TEMP_SENSOR_1 == -2
      #error "如果使用MAX6675热电偶(-2)作为TEMP_SENSOR_1，则TEMP_SENSOR_0必须匹配。"
    #endif
  #endif
  ...
  #define TEMP_SENSOR_1_IS_THERMISTOR 1
    ...
    #if   TEMP_SENSOR_2 == -5
      #error "如果使用MAX31865热电偶(-5)作为TEMP_SENSOR_2，则TEMP_SENSOR_0必须匹配。"
    #elif TEMP_SENSOR_2 == -3
      #error "如果使用MAX31855热电偶(-3)作为TEMP_SENSOR_2，则TEMP_SENSOR_0必须匹配。"
    #elif TEMP_SENSOR_2 == -2
      #error "如果使用MAX6675热电偶(-2)作为TEMP_SENSOR_2，则TEMP_SENSOR_0必须匹配。"
    #endif
  #endif
  ...
  #define TEMP_SENSOR_7_IS_THERMISTOR 1
    ...
    #define TEMP_SENSOR_7_IS_DUMMY 1
      ...
      #error "不支持MAX31865热电偶（-5），除非TEMP_SENSOR_REDUNDANT_SOURCE为TEMP_SENSOR_0/TEMP_SENSOR_1/TEMP_SENSOR_2（0/1/2）。"
    #endif
    ...
    #if !REDUNDANT_TEMP_MATCH(SOURCE, E0) && !REDUNDANT_TEMP_MATCH(SOURCE, E1) && !REDUNDANT_TEMP_MATCH(SOURCE, E2)
      #error "不支持MAX31855热电偶（-3），除非TEMP_SENSOR_REDUNDANT_SOURCE为TEMP_SENSOR_0/TEMP_SENSOR_1/TEMP_SENSOR_2（0/1/2）。"
    #endif
    ...
    #if !REDUNDANT_TEMP_MATCH(SOURCE, E0) && !REDUNDANT_TEMP_MATCH(SOURCE, E1) && !REDUNDANT_TEMP_MATCH(SOURCE, E2)
      #error "不支持MAX6675热电偶（-2），除非TEMP_SENSOR_REDUNDANT_SOURCE为TEMP_SENSOR_0/TEMP_SENSOR_1/TEMP_SENSOR_2（0/1/2）。"
    #endif
  ...
  // mimic setting up the source TEMP_SENSOR
    ...
    #if   TEMP_SENSOR_REDUNDANT == -5
      #error "如果将MAX31865热电偶（-5）用于TEMP_SENSOR_0/TEMP_SENSOR_1/TEMP_SENSOR_2，则TEMP_SENSOR_REDUNDANT必须相匹配。"
    #elif TEMP_SENSOR_REDUNDANT == -3
      #error "如果将MAX31855热电偶（-3）用于TEMP_SENSOR_0/TEMP_SENSOR_1/TEMP_SENSOR_2，则TEMP_SENSOR_REDUNDANT必须相匹配。"
    #elif TEMP_SENSOR_REDUNDANT == -2
      #error "如果将MAX6675热电偶（-2）用于TEMP_SENSOR_0/TEMP_SENSOR_1/TEMP_SENSOR_2，则TEMP_SENSOR_REDUNDANT必须相匹配。"
    #endif
  #endif
  ...
  #error "不支持虚拟传感器用于TEMP_SENSOR_REDUNDANT。"
  ...
  #error "温度传感器3不支持MAX31855热电偶（-3）."
#elif TEMP_SENSOR_3 == -2
  #error "温度传感器3不支持MAX6675热电偶（-2）."
  ...
  #error "温度传感器4不支持MAX31855热电偶（-3）."
#elif TEMP_SENSOR_4 == -2
  #error "温度传感器4不支持MAX6675热电偶（-2）."
  ...
  #error "温度传感器5不支持MAX31855热电偶（-3）."
#elif TEMP_SENSOR_5 == -2
  #error "温度传感器5不支持MAX6675热电偶（-2）."
  ...
  #error "温度传感器6不支持MAX31855热电偶（-3）."
#elif TEMP_SENSOR_6 == -2
  #error "温度传感器6不支持MAX6675热电偶（-2）."
  ...
  #error "温度传感器7不支持MAX31855热电偶（-3）."
#elif TEMP_SENSOR_7 == -2
  #error "温度传感器7不支持MAX7775热电偶（-2）."
  ...
  #error "温度传感器床不支持MAX31855热电偶（-3）."
#elif TEMP_SENSOR_BED == -2
  #error "温度传感器床不支持MAX6675热电偶（-2）."
  ...
  #error "温度传感器室不支持MAX31855热电偶（-3）."
#elif TEMP_SENSOR_CHAMBER == -2
  #error "温度传感器室不支持MAX6675热电偶（-2）."
  ...
  #error "温度传感器冷却器不支持MAX31855热电偶（-3）."
#elif TEMP_SENSOR_COOLER == -2
  #error "温度传感器冷却器不支持MAX6675热电偶（-2）."
  ...
  #define TEMP_SENSOR_PROBE_IS_AD8495 1  // 如果温度传感器类型为-4，则设置TEMP_SENSOR_PROBE_IS_AD8495为1
#elif TEMP_SENSOR_PROBE == -3
  #error "MAX31855热电偶（-3）不支持TEMP_SENSOR_PROBE。"  // 如果温度传感器类型为-3，则输出错误消息
#elif TEMP_SENSOR_PROBE == -2
  #error "MAX6675热电偶（-2）不支持TEMP_SENSOR_PROBE。"  // 如果温度传感器类型为-2，则输出错误消息
#elif TEMP_SENSOR_PROBE == -1
  #define TEMP_SENSOR_PROBE_IS_AD595 1  // 如果温度传感器类型为-1，则设置TEMP_SENSOR_PROBE_IS_AD595为1
#elif TEMP_SENSOR_PROBE > 0
  #define TEMP_SENSOR_PROBE_IS_THERMISTOR 1  // 如果温度传感器类型大于0，则设置TEMP_SENSOR_PROBE_IS_THERMISTOR为1
  #if TEMP_SENSOR_PROBE == 1000
    #define TEMP_SENSOR_PROBE_IS_CUSTOM 1  // 如果温度传感器类型为1000，则设置TEMP_SENSOR_PROBE_IS_CUSTOM为1
  #elif TEMP_SENSOR_PROBE == 998 || TEMP_SENSOR_PROBE == 999
    #define TEMP_SENSOR_PROBE_IS_DUMMY 1  // 如果温度传感器类型为998或999，则设置TEMP_SENSOR_PROBE_IS_DUMMY为1
  #endif
#endif

#if TEMP_SENSOR_BOARD == -4
  #define TEMP_SENSOR_BOARD_IS_AD8495 1  // 如果温度传感器类型为-4，则设置TEMP_SENSOR_BOARD_IS_AD8495为1
#elif TEMP_SENSOR_BOARD == -3
  #error "MAX31855热电偶（-3）不支持TEMP_SENSOR_BOARD。"  // 如果温度传感器类型为-3，则输出错误消息
#elif TEMP_SENSOR_BOARD == -2
  #error "MAX6675热电偶（-2）不支持TEMP_SENSOR_BOARD。"  // 如果温度传感器类型为-2，则输出错误消息
#elif TEMP_SENSOR_BOARD == -1
  #define TEMP_SENSOR_BOARD_IS_AD595 1  // 如果温度传感器类型为-1，则设置TEMP_SENSOR_BOARD_IS_AD595为1
#elif TEMP_SENSOR_BOARD > 0
  #define TEMP_SENSOR_BOARD_IS_THERMISTOR 1  // 如果温度传感器类型大于0，则设置TEMP_SENSOR_BOARD_IS_THERMISTOR为1
  #if TEMP_SENSOR_BOARD == 1000
    #define TEMP_SENSOR_BOARD_IS_CUSTOM 1  // 如果温度传感器类型为1000，则设置TEMP_SENSOR_BOARD_IS_CUSTOM为1
  #elif TEMP_SENSOR_BOARD == 998 || TEMP_SENSOR_BOARD == 999
    #define TEMP_SENSOR_BOARD_IS_DUMMY 1  // 如果温度传感器类型为998或999，则设置TEMP_SENSOR_BOARD_IS_DUMMY为1
  #endif
#endif
