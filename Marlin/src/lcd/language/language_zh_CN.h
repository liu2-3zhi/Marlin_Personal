...
//人工修正
  ...
  LSTR MSG_PROBE_WIZARD                   = _UxGT("探针Z偏移自测量");
  LSTR MSG_PROBE_WIZARD_PROBING           = _UxGT("正在测量探针的Z偏移");
  LSTR MSG_PROBE_WIZARD_MOVING            = _UxGT("移动到探测位置");
  LSTR MSG_FILAMENT_EN                    = _UxGT("*耗材情况");
  LSTR STR_ENDSTOP_HIT_Test               = _UxGT("触发");
  LSTR STR_ENDSTOP_OPEN_Test              = _UxGT("未触发");
  LSTR _HOME_TO_MAX                       = _UxGT("最大值");
  LSTR _HOME_TO_MIN                       = _UxGT("最小值");
  LSTR MSG_Z_PROBE                        = _UxGT("Z探针");
  LSTR MSG_MOVE_50MM                      = _UxGT("移动 50mm");
  #undef MSG_ADVANCE_K
  #undef MSG_ADVANCE_K_E
