...
#define AUTOTEMP
  ...
  //#define AUTOTEMP_PROPORTIONAL
    ...
    #define AUTOTEMP_MIN_P      190 // (°C) Added to the target temperature
    #define AUTOTEMP_MAX_P      270 // (°C) Added to the target temperature
...
#define ADVANCED_PAUSE_FEATURE
  ...
  #define PAUSE_PARK_NOZZLE_TIMEOUT           5//45  // (seconds) Time limit before the nozzle is turned off for safety.
