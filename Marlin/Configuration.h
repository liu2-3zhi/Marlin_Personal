...
#define STRING_CONFIG_H_AUTHOR "(Zelly, Adapt to MKS Robin E3 With TMC2209)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "MKS Robin E3"
...
//#define NEOPIXEL_LED
  ...
  #define NEOPIXEL_PIN     PF6//4       // LED driving pin
