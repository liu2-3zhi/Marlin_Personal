...
// 检查默认PID参数是否大于0
constexpr float pid_value1 = DEFAULT_Kp_Key;
#pragma message("DEFAULT_Kp_Key = " STRINGIFY(DEFAULT_Kp_Key))
#if pid_value1 <= 0
    #error "DEFAULT_Kp_Key 必须大于0"
#endif

constexpr float pid_value2 = DEFAULT_Ki_Key;
#pragma message("DEFAULT_Ki_Key = " STRINGIFY(DEFAULT_Ki_Key))
#if pid_value2 <= 0
    #error "DEFAULT_Ki_Key 必须大于0"
#endif

constexpr float pid_value3 = DEFAULT_Kd_Key;
#pragma message("DEFAULT_Kd_Key = " STRINGIFY(DEFAULT_Kd_Key))
#if pid_value3 <= 0
    #error "DEFAULT_Kd_Key 必须大于0"
#endif

// 检查热床PID参数是否大于0
constexpr float pid_value4 = DEFAULT_bedKp_Key;
#pragma message("DEFAULT_bedKp_Key = " STRINGIFY(DEFAULT_bedKp_Key))
#if pid_value4 <= 0
    #error "DEFAULT_bedKp_Key 必须大于0"
#endif

constexpr float pid_value5 = DEFAULT_bedKi_Key;
#pragma message("DEFAULT_bedKi_Key = " STRINGIFY(DEFAULT_bedKi_Key))
#if pid_value5 <= 0
    #error "DEFAULT_bedKi_Key 必须大于0"
#endif

constexpr float pid_value6 = DEFAULT_bedKd_Key;
#pragma message("DEFAULT_bedKd_Key = " STRINGIFY(DEFAULT_bedKd_Key))
#if pid_value6 <= 0
