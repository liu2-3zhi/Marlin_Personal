...
// 检查默认PID参数是否为正数
#if DEFAULT_Kp_Key <= 0
    #error "DEFAULT_Kp_Key 必须是正数"
#endif

#if DEFAULT_Ki_Key <= 0
    #error "DEFAULT_Ki_Key 必须是正数"
#endif

#if DEFAULT_Kd_Key <= 0
    #error "DEFAULT_Kd_Key 必须是正数"
#endif

// 检查热床PID参数是否为正数  
#if DEFAULT_bedKp_Key <= 0
    #error "DEFAULT_bedKp_Key 必须是正数"
#endif

#if DEFAULT_bedKi_Key <= 0
    #error "DEFAULT_bedKi_Key 必须是正数"
#endif

#if DEFAULT_bedKd_Key <= 0
    #error "DEFAULT_bedKd_Key 必须是正数"
#endif
